...
- **AAAI-2027 (AISI Track)** — *From Pixels to Decisions: Validating Deployable Coronary IVUS Analysis at the Level That Informs Treatment* · under review
- **MICCAI 2026** — *Clinically Aligned Geometry Constraints for Robust IVUS Vessel Boundary Segmentation* · under review
- **IEEE BIBM** — *Confidence-Adaptive Trimap for Boundary-Precise Zebrafish Myotome Segmentation* · under review
